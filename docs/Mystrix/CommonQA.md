...
## Where is the 203 system based?

203 System is based in the US. It is currently run by me, Nengzhuo Cai (also known as Null). 203 is not a full-time job yet, and I move from place to place, so there is no single physical location.

## How do I get started with Mystrix?

Please refer to the [quick start guide](./GettingStarted) for Mystrix.

## Why is the Mystrix labeled as Matrix on the box?

Mystrix underwent a branding change in 2024; the box was not reprinted.

## Why is the magnet falling out? What are the extra pieces in the box?
...
## Why is the bottom pad not pre-installed?
...
## Why is there no documentation or quick start guide in the box?
...
## What is the main focus of Mystrix? It seems very open-ended with no clear focus.
...
## What are you doing differently for Mystrix 2?
