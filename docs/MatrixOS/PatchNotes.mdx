...
### Matrix OS 3.0 Beta 4

#### New Features
- **Custom Scale in Note App**: Create and save custom musical scales
- **Modern Diatonic Scale Mode in Note App**: Enhanced diatonic scale mode with root offset selection
- **MIDI Clock Out Support in Note App**: Send MIDI clock sync signals to external devices
- **Arpeggiator Reset Buttons**: Quick reset buttons for arpeggiator parameters
- **Fast Text Scroll Feature**: Improved text scrolling performance system-wide

#### Improvements
- System-wide improvements and bug fixes

### Matrix OS 3.0 Beta 3

#### Bug Fixes
- Fixed LED glitching in certain situations
- Various small fixes for Note App V2
