...
A Micro SD card must be installed in your device to use standalone Python applications. See [Install Micro SD Card](/docs/Mystrix/InstallMicroSD) for installation instructions.
:::
