...
2. HID-specific keycodes (`HID_CONSUMER_*`, `HID_SYSTEM_*`) follow the HID standard for device communication.
3. Gamepad and mouse keycodes are tailored for hardware interaction.
```
