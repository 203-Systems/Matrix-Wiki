...
*The source file for this UI utility is located in <GithubLink path="os/ui/UIUtilities.h"/> and it's implemented in <GithubLink path="os/ui/Utlities/TextScroll.cpp"/>.*
---
