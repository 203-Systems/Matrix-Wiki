...
However, you can make your changes take effect immeadiately by write to layer 0, which is the active buffer. Your changes will be rendered to the device immeadiately. (Unless you pause the update with `PauseUpdate(true)`)
