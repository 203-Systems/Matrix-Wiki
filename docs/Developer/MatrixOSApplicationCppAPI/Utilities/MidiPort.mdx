...
The `MidiPort` class provides functionality to manage MIDI ports, including opening, closing, sending, and receiving MIDI packets. It part of the Matrix OS MIDI system.
...
The ID of the MIDI port. Defaults to `MIDI_PORT_INVALID`.
