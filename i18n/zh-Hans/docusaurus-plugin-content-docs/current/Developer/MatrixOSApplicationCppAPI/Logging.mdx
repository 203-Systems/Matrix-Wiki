...
注意：可以通过在构建命令中使用 build-dev 将系统日志级别设置为调试。所有其他命令的日志级别为 None。如果使用 build，将使用 os/Parameters.h 文件中的默认日志级别。（详情请参阅 <DocLink to="/docs/Developer/DebugMatrixOS/DebugMatrixOSCpp/">调试 Matrix OS</DocLink>。）
